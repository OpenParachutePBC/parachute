...
enum ContentType {
  ...
  /// Daily journal entries (Daily/*.md)
  journal,

  /// Chat sessions (agent-sessions/*.md)
  chat,
}
...
class IndexedChunk {
  ...
  /// ID of the content this chunk belongs to (recording ID, journal entry ID, etc.)
  final String recordingId;

  /// Type of content this chunk came from
