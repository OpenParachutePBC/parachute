...
/// Search content widget - extracted from SearchScreen
///
/// Supports two modes:
...
class _SearchContentState extends ConsumerState<SearchContent> {
  ...
  void _setupIndexingListener() async {
    try {
      ...
      debugPrint('[SearchContent] Error setting up indexing listener: $e');
    }
  }
  ...
  Future<void> _triggerSearchIndexSync() async {
    try {
      debugPrint('[SearchContent] Triggering search index sync after model download...');
      ...
      debugPrint('[SearchContent] Error during index sync: $e');
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        if (_results != null && _results!.isNotEmpty && _searchController.text.isNotEmpty)
          Positioned(
            right: 16,
            bottom: 16,
