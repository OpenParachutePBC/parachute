...
import 'package:parachute_chat/services/parakeet_service.dart';
import 'package:parachute_chat/services/sherpa_onnx_service.dart';
import 'package:parachute_chat/services/sherpa_onnx_isolate.dart';
...
class TranscriptionInitNotifier extends StateNotifier<TranscriptionInitState> {
  ...
  Future<void> checkStatus() async {
    ...
    try {
      ...
      if (modelsDownloaded) {
        // Models exist but not initialized - initialize now
