...
class WavBytesUtil {
  ...
  void storeFramePacket(List<int> packet) {
    ...
    // Start of new frame - ALWAYS accept frameId == 0 as new frame start
    // This handles both fragmented and single-packet frames
    if (frameId == 0) {
      // Save previous pending frame if it exists
