...
import 'package:parachute_chat/features/recorder/screens/device_pairing_screen.dart';
...
class OmiDeviceSection extends ConsumerWidget {
    ...
    return Column(
      ...
      children: [
        const SettingsSubsectionHeader(
          title: 'Omi Device Pairing',
          subtitle: 'Connect your Omi wearable device to record with a button tap',
        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.system_update, color: BrandColors.turquoiseDeep, size: 24),
              SizedBox(width: Spacing.md),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Future<void> _checkFirmwareUpdate(BuildContext context, WidgetRef ref) async {
