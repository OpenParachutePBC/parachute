...
**New Files:**
- `app/lib/core/services/github/github_oauth_service.dart`
- `app/lib/core/services/github/github_api_service.dart`
- `app/lib/core/providers/github_auth_provider.dart`
- `app/lib/features/settings/widgets/github/github_connect_wizard.dart`
- `app/lib/features/settings/widgets/github/repository_selector.dart`
- `app/lib/features/settings/widgets/github/create_repository_dialog.dart`
...
**Modified Files:**
- `app/lib/main.dart` - Load .env on startup
- `app/lib/features/settings/widgets/git_sync_settings_card.dart` - Add OAuth wizard
- `app/pubspec.yaml` - New dependencies + .env asset
- `app/ios/Runner/Info.plist` - Deep linking config
- `app/macos/Runner/Info.plist` - Deep linking config
- `app/android/app/src/main/AndroidManifest.xml` - Deep linking config
...
**After:**
- 4 clicks (Connect → Authorize → Select Repo → Complete)
- ~30 seconds
...
✅ Secure token storage (platform keystores)
